import os
class script(object):
    START_TXT = """<>b ʜᴇʟʟᴏ {} 👋, \n\n ᴍʏ ɴᴀᴍᴇ ɪꜱ {} ♡ミ, ᴊᴜꜱᴛ ᴇɴᴛᴇʀ ʏᴏᴜʀ ᴍᴏᴠɪᴇ, ꜱᴇʀɪᴇꜱ, ᴀɴɪᴍᴇ ᴏʀ ᴋ-ᴅʀᴀᴍᴀ ɴᴀᴍᴇ & ɢᴇᴛ ᴀʟʟ ɪᴛ. \n\n ᴄʀᴇᴀᴛᴇᴅ ᴡɪᴛʜ ❤️ : @moviesvisit </b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/moviesvisit'>MOVIES BOX</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : JISSHU\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/Rohit1211p'>ROHIT</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n𝖩𝗈𝗂𝗇➥ 「<a href="https://t.me/movieboxbot1">MOVIES BOX</a>」</b>"""
...
🏷️ <a href='https://t.me/movieboxbot1'>MOVIES GROUP</a>
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/movieboxbot1/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href=https://t.me/movieboxbot1/10>Explain</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/Rohit1211p">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://t.me/https://t.me/moviesvisit">MOVIES BOX</a></blockquote>
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/Rohit1211p">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/Rohit1211p">ᴀᴅᴍɪɴ</a></b>"""
